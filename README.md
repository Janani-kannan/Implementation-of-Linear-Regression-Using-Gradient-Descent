...
1. Initialize the model parameters (slope m and intercept b) with small values and choose a learning rate.
2. Predict the output for all training data and calculate the error (cost function).
3. Update m and b by computing the gradients and adjusting them using gradient descent.
4. Repeat the update process until the cost is minimized or the maximum number of iterations is reached.
...
<img width="522" height="226" alt="image" src="https://github.com/user-attachments/assets/f6db1fe7-62b3-45b8-8e76-8b8d82f10025" />


<img width="681" height="220" alt="image" src="https://github.com/user-attachments/assets/69b0933d-887f-4046-a292-ec6ea3ba06ff" />


<img width="260" height="50" alt="image" src="https://github.com/user-attachments/assets/95d50797-fbe2-4227-85bf-75bb40b2618e" />


<img width="376" height="31" alt="image" src="https://github.com/user-attachments/assets/ba678ff0-ac2e-4c06-8e9b-0ad2cd15c477" />


<img width="590" height="276" alt="image" src="https://github.com/user-attachments/assets/268610fd-5f33-40f4-97c3-bbfe5e82c5ec" />


<img width="736" height="415" alt="image" src="https://github.com/user-attachments/assets/a3477311-b052-4f96-b728-256eb0d73acd" />


<img width="573" height="75" alt="image" src="https://github.com/user-attachments/assets/bce98da9-ed4c-49e6-953b-858d10ad6ac6" />
